...
<h2> O Be The Hero foi criado para que as ONGs se conectem .</h3>

<p> <img src="imgs/heroes.png" alt="heroes" height="250"> </p>

<p> Usando o poder de uma stack poderosa, que utiliza de uma única linguagem popular e moderna, o <img src="imgs/js.png" height="18" alt="javascript"> JavaScript. <br> Produtividade e performance de forma enxuta. </p>
...
Para rodar os comandos abaixo, pode-se usar os gerenciadores de pacotes yarn ou npm.

Utilize ```npm install``` nas pastas frontend, backend e mobile para instalar as depe
...
<h4 align="center"><a href="https://github.com/mikaws" target="_blank">Michael Henrique</a> </h4>
